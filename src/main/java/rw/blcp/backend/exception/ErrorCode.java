...
public enum ErrorCode {
    ...
    RESOURCE_ALREADY_EXISTS("A resource with the same identifier already exists", HttpStatus.CONFLICT),

    INVALID_STATE_TRANSITION("This action is not allowed in the current application state", HttpStatus.UNPROCESSABLE_ENTITY),
    CONCURRENT_MODIFICATION("The application was modified by another user, please retry", HttpStatus.CONFLICT),
    REVIEWER_APPROVER_CONFLICT("The reviewer of an application cannot be its final approver", HttpStatus.FORBIDDEN),
