package rw.blcp.backend.core.auth.aspect;
...
public class AuthorizationAspect {
  ...
  @Pointcut("@within(rw.blcp.backend.core.auth.annotation.RequiredRoles)")
  private void classLevelRole() {}

  @Pointcut("@annotation(rw.blcp.backend.core.auth.annotation.RequiredRoles)")
