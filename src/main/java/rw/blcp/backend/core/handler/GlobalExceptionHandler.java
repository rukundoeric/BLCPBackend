...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleAuthentication(AuthenticationException ex) {
        ...
        return ResponseEntity
                ...
                .body(ApiErrorResponse.of(ErrorCode.INVALID_CREDENTIALS.name(), ErrorCode.INVALID_CREDENTIALS.getMessage()));
    }
    ...
    public ResponseEntity<ApiErrorResponse> handleAccessDenied(AccessDeniedException ex) {
        ...
        return ResponseEntity
                ...
                .body(ApiErrorResponse.of(ErrorCode.ACCESS_DENIED.name(), ErrorCode.ACCESS_DENIED.getMessage()));
    }
    ...
    public ResponseEntity<ApiErrorResponse> handleGeneric(Exception ex) {
        ...
        return ResponseEntity
                ...
                .body(ApiErrorResponse.of(ErrorCode.INTERNAL_ERROR.name(), ErrorCode.INTERNAL_ERROR.getMessage()));
    }
}
